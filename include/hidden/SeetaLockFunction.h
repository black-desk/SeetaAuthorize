...
struct SeetaLock_VerifyLAN :
  public SeetaLock_FunctionID<SeetaLock_VerifyLAN_ID> {
    SeetaLock_VerifyLAN() : SeetaLock_VerifyLAN(0) {}
    explicit SeetaLock_VerifyLAN(int keyid) : in({ keyid }), out({ 0 }) {}
    struct {
        int key_code;
    } in;
    struct {
...
struct SeetaLock_ErrorMessage :
  public SeetaLock_FunctionID<SeetaLock_ErrorMessage_ID> {
    explicit SeetaLock_ErrorMessage(int errcode) :
      in({ errcode }), out({ nullptr }) {}
    struct {
        int errcode;
    } in;
    struct {
...
struct SeetaLock_VerifyLANParallel :
  public SeetaLock_FunctionID<SeetaLock_VerifyLANParallel_ID> {
...
struct SeetaLock_Verify_Key_Code :
  public SeetaLock_FunctionID<SeetaLock_Verify_Key_Code_ID> {
...
struct SeetaLock_Verify_GetModelJug :
  public SeetaLock_FunctionID<SeetaLock_Verify_GetModelJug_ID> {
    SeetaLock_Verify_GetModelJug() : SeetaLock_Verify_GetModelJug(0) {}
    explicit SeetaLock_Verify_GetModelJug(const char *modelfile) :
      in({ modelfile }), out({ 0, orz::jug() }) {}
    struct {
        const char *file;
    } in;
    struct {
...
struct SeetaLock_Verify_GetModelJug_FromStream :
  public SeetaLock_FunctionID<SeetaLock_Verify_GetModelJug_FromStream_ID> {
    SeetaLock_Verify_GetModelJug_FromStream() :
      SeetaLock_Verify_GetModelJug_FromStream(0) {}
    explicit SeetaLock_Verify_GetModelJug_FromStream(orz::InputStream *input) :
      in({ input }), out({ 0, orz::jug() }) {}
    struct {
