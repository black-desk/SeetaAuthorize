...
namespace orz
{
  ...
  /**
   * This class parse the json model file,sta and csta model file to get the
   * model file's orz::jug object
   */
  class CstaModelFileInputStream : public InputStream {
    public:
       ...
       * @return return the number of characters read, If no char is available
       * because the end of the stream has been reached, the 0 is returned. an
       * exception happen will return -1.
       */
  ...
  class CstaModelFileOutputStream : public OutputStream {
    public:
      ...
      @return return the number of characters written, an exception happen will
      return -1.
      */
